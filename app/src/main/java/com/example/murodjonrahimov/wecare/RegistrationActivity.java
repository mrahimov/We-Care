        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (doctorCheckbox.isChecked() && licence.equals("")) {
                    Toast.makeText(RegistrationActivity.this, "Please enter a valid licence id", Toast.LENGTH_LONG).show();
                }
                        ...
                        .addOnCompleteListener(new OnCompleteListener<ProviderQueryResult>() {
                            ...
                            public void onComplete(@NonNull Task<ProviderQueryResult> task) {
                                ...
                                boolean check = !task.getResult()
                                        ...
                                        .isEmpty();
                                if (check) {
                                    Toast.makeText(RegistrationActivity.this, "It looks like you already have a WeCare account for this email address. Please try login in.", Toast.LENGTH_LONG).show();
                                    return;
                                }
