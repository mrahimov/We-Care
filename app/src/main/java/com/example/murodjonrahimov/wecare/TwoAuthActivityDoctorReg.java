  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    button.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        if (lastName.getText()
          .toString()
          .matches("") && firstName.getText()
          .toString()
          .matches("") && country.getText()
          .toString()
          .matches("") && medical.getText()
          .toString()
          .matches("") && yearsofEXP.getText()
          .toString()
          .matches("")

          ) {

          Toast.makeText(getApplicationContext(), "information invalid", Toast.LENGTH_LONG)
            .show();
        } else {
          ...
          doctor.setLastName(lastName.getText()
            .toString());
          doctor.setCountryOfPractice(country.getText()
            .toString());
          doctor.setYearsOfExperience(yearsofEXP.getText()
            .toString());
