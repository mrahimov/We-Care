    ...
    search.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        if (searchText.getText()
          ...
          Toasty.normal(getActivity().getApplicationContext(), "searching for " + searchText.getText()
            .toString(), 500)
            .show();
          listenerDoc.search(searchText.getText()
            .toString());
        }
      }
    });
        ...
        holder.button.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View v) {
            if (user.equals(doctor.getAddedBy())) {
              fireBaseRecyclerAdapter.getRef(holder.getAdapterPosition())
                .removeValue();
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View v) {
            ...
            listenerDoc.onclick(key, doctor.getMessage(), doctor.getTimeStamp(), doctor.getAddedBy(),
              doctor.getFirstname() + " " + doctor.getLastname(), doctor.getUri());
          }
        });
      }
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    switch (item.getItemId()) {
      case R.id.MyPost:
        ...
        Toasty.normal(getActivity(), "My Posts")
          .show();
